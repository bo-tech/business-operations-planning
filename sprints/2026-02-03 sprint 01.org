...
- [ ] Update ~default-repository~ template (sphinx-builder URL to GitHub)
- [ ] Publish ~default-repository~ template to GitHub/bo-tech
- [ ] Create ~business-operations~ repository using the template
